...
<script lang="ts">
  ...
  const ICONS: Record<string, string> = {
    ...
    pack: '<circle cx="12" cy="5" r="2.6"/><circle cx="5" cy="18" r="2.6"/><circle cx="19" cy="18" r="2.6"/><path d="M11 7.3 6.5 15.6M13 7.3l4.5 8.3"/>',
    settings:
      ...
      <div class="sidebar-nav">
        ...
        {:else}
          ...
          <a
            href="/pack"
            class="nav-item"
            class:active={isActive('/pack')}
            onclick={navClick}
            title="Pack">{@render ic('pack')}<span>Pack</span></a
          >
