...
<script lang="ts">
  ...
  onMount(async () => {
    try {
      ...
      toast.err(e?.message ?? 'Failed to load networks');
    }
    loading = false;
...
<div class="panel">
  <div class="panel-head net-head">
    <input
      ...
      type="text"
      bind:value={filter}
      placeholder="Filter by SSID or protocol…"
    />
    ...
    <div class="empty-state">
      <div class="empty-icon">
        <svg
          ...
          ><path d="M5 12.55a11 11 0 0 1 14.08 0"></path><path d="M1.42 9a16 16 0 0 1 21.16 0"
            ...
            <tr>
              ...
              <td class="actions-col">
                <div class="row-actions">
                  ...
                  <button class="action-btn del-btn" onclick={() => deleteNetwork(net.id)}
                    >Del</button
                  >
                </div>
              </td>
